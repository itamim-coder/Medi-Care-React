...
const Banner = () => {
  ...
  <Carousel.Item>
    ...
    <div className="hero-text">
     ...
     <NavLink to="/aboutus"> <button className="banner-btn">Learn More</button></NavLink>
    </div>
  </Carousel.Item>
  <Carousel.Item>
    <img
...
<div className="hero-text">
      ...
      <NavLink to="/aboutus"> <button id="main" className="banner-btn">Learn More</button></NavLink>
